...
local ingest = require("lual.log.ingest")
...
describe("lualog Logger Object", function()
  ...
  describe("lualog.get_logger(name)", function()
    it("should create a root logger correctly", function()
      ...
      package.loaded["lual.log.luallog"] = nil -- Attempt to reset cache by reloading module
      local fresh_lualog = require("lual.log.luallog")
    ...
    it("should create a named logger and its parents", function()
      package.loaded["lual.log.luallog"] = nil 
      local fresh_lualog = require("lual.log.luallog")
  ...
  describe("Logger Methods", function()
    ...
    before_each(function()
      package.loaded["lual.log.luallog"] = nil 
      local fresh_lualog_for_method_tests = require("lual.log.luallog")
    ...
    describe("logger:get_effective_handlers()", function()
      ...
      before_each(function()
        package.loaded["lual.log.luallog"] = nil 
        fresh_lualog_for_handlers = require("lual.log.luallog")
