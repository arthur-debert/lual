...
describe("lual Logger - Effective Level Calculation (Step 2.5)", function()
    ...
    describe("_get_effective_level() method", function()
        it("should return explicit level when logger has non-NOTSET level", function()
            ...
            local logger = lual.create_logger("test.logger", core_levels.definition.DEBUG, nil)
        ...
        it("should return explicit level for different levels", function()
            ...
            for _, level in ipairs(test_levels) do
                local logger = lual.create_logger("test.logger", level, nil)
                local effective_level = logger:_get_effective_level()
        ...
        it("should return root config level when logger is _root with NOTSET", function()
            ...
            local root_logger = lual.create_logger("_root", core_levels.definition.NOTSET, nil)
        ...
        it("should inherit level from parent when logger has NOTSET", function()
            ...
            local parent_logger = lual.create_logger("parent", core_levels.definition.WARNING, nil)

            -- Create child with NOTSET level
            local child_logger = lual.create_logger("parent.child", core_levels.definition.NOTSET, parent_logger)
        ...
        it("should recursively inherit through multiple levels", function()
            ...
            local grandparent = lual.create_logger("grandparent", core_levels.definition.ERROR, nil)
            local parent = lual.create_logger("grandparent.parent", core_levels.definition.NOTSET, grandparent)
            local child = lual.create_logger("grandparent.parent.child", core_levels.definition.NOTSET, parent)
        ...
        it("should stop at first explicit level in hierarchy", function()
            ...
            local grandparent = lual.create_logger("grandparent", core_levels.definition.ERROR, nil)
            local parent = lual.create_logger("grandparent.parent", core_levels.definition.INFO, grandparent)
            local child = lual.create_logger("grandparent.parent.child", core_levels.definition.NOTSET, parent)
        ...
        it("should fallback to INFO when no parent and not root", function()
            ...
            local orphan_logger = lual.create_logger("orphan", core_levels.definition.NOTSET, nil)
        ...
        it("should handle deep hierarchy correctly", function()
            ...
            local root = lual.create_logger("root", core_levels.definition.CRITICAL, nil)
            local level1 = lual.create_logger("root.l1", core_levels.definition.NOTSET, root)
            local level2 = lual.create_logger("root.l1.l2", core_levels.definition.NOTSET, level1)
            local level3 = lual.create_logger("root.l1.l2.l3", core_levels.definition.NOTSET, level2)
            local level4 = lual.create_logger("root.l1.l2.l3.l4", core_levels.definition.NOTSET, level3)
    ...
    describe("Integration with config system", function()
        ...
        it("should update effective level when config changes", function()
            ...
            local child = lual.create_logger("child", core_levels.definition.NOTSET, root_logger)
    ...
    describe("Edge cases and error conditions", function()
        it("should handle logger with no name gracefully", function()
            local logger = lual.create_logger(nil, core_levels.definition.NOTSET, nil)
        ...
        it("should handle all NOTSET hierarchy", function()
            ...
            local parent = lual.create_logger("parent", core_levels.definition.NOTSET, nil)
            local child = lual.create_logger("child", core_levels.definition.NOTSET, parent)
        ...
        it("should handle circular references gracefully", function()
            -- Create two loggers
            local logger1 = lual.create_logger("logger1", core_levels.definition.NOTSET, nil)
            local logger2 = lual.create_logger("logger2", core_levels.definition.NOTSET, nil)
    ...
    describe("Performance and behavior", function()
        it("should be efficient for single-level lookup", function()
            local logger = lual.create_logger("test", core_levels.definition.WARNING, nil)
        ...
        it("should be deterministic", function()
            -- Set up hierarchy
            local root = lual.create_logger("root", core_levels.definition.ERROR, nil)
            local child = lual.create_logger("child", core_levels.definition.NOTSET, root)
